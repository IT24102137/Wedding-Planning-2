                    ...
                    <div class="card shadow-lg" data-aos="fade-up">
                        <div class="card-body p-5">
                            <form id="contactForm">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control" id="message" rows="5" placeholder=" " style="height: auto; padding-top: 15px; padding-bottom: 15px;" required></textarea>
                                    <i class="fa-solid fa-comment" style="top: 25px;"></i>
