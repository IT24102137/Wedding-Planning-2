...
<style>
    ...
    :root {
        ...
        --bg-card: #ffebf1;              /* Very light pink for cards */
        --bg-element: #fff7fa;           /* Extremely light pink for elements */
    ...
    .dashboard-hero {
        background-image: 
            linear-gradient(to right, 
                rgba(255, 231, 255, 0.95) 0%, 
                rgba(255, 231, 255, 0.85) 40%, 
                rgba(245, 145, 203, 0.5) 70%, 
                rgba(211, 71, 145, 0.3) 100%),
