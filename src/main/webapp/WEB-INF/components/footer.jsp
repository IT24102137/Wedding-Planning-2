        ...
        <div class="row">
            <div class="col-md-4 mb-4 mb-md-0">
                ...
                <div class="social-links">
                    <a href="https://www.facebook.com/janith.deshan.186" class="me-2"><i class="fab fa-facebook-f"></i></a>
                    <a href="https://www.instagram.com/janith_deshan11" class="me-2"><i class="fab fa-twitter"></i></a>
            ...
            <div class="col-md-3">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><i class="fas fa-map-marker-alt me-2"></i> 123 Home ,Homagama , Sri Lanka</li>
                    <li class="mb-2"><i class="fas fa-phone me-2"></i> +94703638365</li>
                    <li class="mb-2"><i class="fas fa-envelope me-2"></i> janithmihijaya123@gmail.com</li>
                </ul>
            </div>
        </div>
        <hr>
